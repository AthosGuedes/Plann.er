                ...
                <form className='space-y-3'>
                    ...
                    <div className="flex items-center gap-2">
                        <div className='h-14 px-4 flex-1 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2'>
                            ...
                            <input type="datetime-local" name='occurs_at' placeholder="Data e horario da atividade" className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-1 [color-scheme:dark;]" />
                        </div>
                        
                        {/**
                        <div className='w-36 h-14 px-4 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2'>
